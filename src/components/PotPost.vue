    ...
    <div class="container-center-horizontal">
      <div class="potpost-participants screen">
        <div class="flex-col">
          ...
          <div class="view">
            <div class="overlap-group-1"><div class="text-97 dmsans-bold-black-24px"><img :src = "categories[pot.category]" /> </div></div>
            <div class="flex-col-1">
              <div class="overlap-group1">
                <div class="text-95 valign-text-middle dmsans-bold-masala-24px">{{pot.title}}</div>
                <div class="nn dmsans-bold-tropical-rain-forest-20px">{{headcount}}/{{pot.max}}</div>
              </div>
            ...
            <!-- <a href="javascript:ShowOverlay('participationoverlay', 'animate-appear');"> -->
              ...
              <div class = "participation" v-if="auth.currentUser?.uid === pot.uid">
                ...
                <div class="overlap-group4">
                  <div class="label valign-text-middle dmsans-bold-white-17px">모집마감</div>
                </div>
              </div>
              </div>
              22222
          ...
          <div class="bottombar">
            <div class="overlap-group6">
              ...
              <a href="/pothomescreen" data-turbolinks="false">
